...
?>
	<div class="container wrapper">
		...
		<?php
		while ($cloth_row = $result->fetch_assoc()):
			$cloth_id = $cloth_row['cloth_id'];
			$review_str = "SELECT * FROM $reviews WHERE review_cloth_id='$cloth_id'";
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">
									<a href="clothdetails.php?id=<?= $cloth_row['cloth_id'] ?>"><?= $cloth_row['cloth_name'] ?></a>
								</h3>
							</div>
