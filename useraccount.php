	...
	<div class="container wrapper">
		...
		<div class="row">
			<div class="col-xs-8 col-xs-offset-2">
				...
				<p class="lead">Welcome to your user dashboard! Here you can edit your information, see favorite clothes, and your own reviews!</p>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-8 col-xs-offset-2">
				<form name="edituser" class="form-horizontal" role="form" action="updateaccount.php" method="get" enctype="text/plain">
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							<a href="javascript:document.edituser.submit()" class="btn btn-info">UPDATE</a>
		...
		<div class="row">
			...
			<div class="col-xs-6">
				<h2 class="text-center text-info"><a style="text-decoration:none;" href="wishlist.php">Your Favorites</a></h2>
			</div>

			<div class="col-xs-6">
				<h2 class="text-center text-info"><a style="text-decoration:none;" href="yourreviews.php"> Your Reviews </a></h2>
			</div>
