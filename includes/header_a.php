...
<head>
	...
	<link rel="stylesheet" href="assets/css/main_z.css"/>
	<link rel="icon" href="assets/my_img/title_icon.png">
...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
	<div class="container-fluid">
		...
		<div class="navbar-header">
		    <a href="index.php" class="navbar-brand"><i class="fa fa-shopping-cart fa-lg" aria-hidden="true"></i> Pranil.in</a>
		...
		<div class="">
			<div id="navbar" class="navbar-collapse collapse">
					...
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu" role="menu">
								...
								<li><a href="clothes.php">ITEMS</a></li>
								<li><a href="reviews.php">REVIEWS</a></li>
								<li><a href="addcloth.php">ADD CLOTH</a></li>
				...
				if (empty($login)) : ?>
					...
					<ul class="nav navbar-nav navbar-left">
					    <li><a href="index.php" class="text-capitalize">Welcome, Guest!</a></li>
				    </ul>
